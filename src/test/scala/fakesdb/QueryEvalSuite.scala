...
class QueryEvalSuite extends FunSuite {
  ...
  
  {
    ...
    domain.getOrCreate("0385333498").put("Keyword", Set("Book", "Paperback"), false)
    domain.getOrCreate("0385333498").put("Rating", Set("*****", "5 stars", "Excellent"), false)
    ...
    domain.getOrCreate("1579124585").put("Keyword", Set("Book", "Hardcover", "American"), false)
    domain.getOrCreate("1579124585").put("Rating", Set("****", "4 stars"), false)
    ...
    domain.getOrCreate("B000T9886K").put("Keyword", Set("CD", "Trance"), false)
    ...
    domain.getOrCreate("B00005JPLW").put("Keyword", Set("DVD", "Action", "Frank Miller"), false)
    domain.getOrCreate("B00005JPLW").put("Rating", Set("***", "3 stars", "Not bad"), false)
