...
class Item(val name: String) {
  ...
  def put(attrName: String, value: String, replace: Boolean): Unit = put(attrName, Set(value), replace)
  def put(attrName: String, values: Set[String], replace: Boolean): Unit = {
